...
```
Looking at variation in maximum and minimum load. 
...
```
   ...
   * Overall increasing trends: Gas, waste, other renewable, hydro river
step changes seen in: 
   ...
   * oil, start 2016, drop
   * other renewable, 2016 start, 2017 start, increase
   *other, 2016 start decrease
